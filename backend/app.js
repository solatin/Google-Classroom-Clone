...
app.get('/class-details/:id/feed', async(req, res) => {
    ...
    // return Class.findById({ _id: req.params.id }, { _id: Account._id })

    // const classData = await Class.findById(req.params.id);
    const classData = await Class.find({ teacher_id: Account._id }).populate("teacher_id");
    console.log(classData);
    res.json(classData);

    // console.log(Class.teacher_id);

    // const data = Class.find({ teacher_id: Account._id }).populate({ path: "teacher_id", select: ['display_name'] });
    // console.log(data);
